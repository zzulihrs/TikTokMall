module bytetech/course/app/user

go 1.23.1

replace (
	bytetech/course/common => ../../common
	// 由于之前把 handler 都拿出来了，所以这些包没有生成，需要用本地的。
	// go mod tidy 一下，本地查找这个些包。
	bytetech/course/rpc_gen => ../../rpc_gen
	github.com/apache/thrift => github.com/apache/thrift v0.13.0
)

require (
	bytetech/course/common v0.0.0-00010101000000-000000000000
	bytetech/course/rpc_gen v0.0.0-00010101000000-000000000000
