...
func (x *CreditCardInfo) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.CreditCartNumber, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}
...
func (x *CreditCardInfo) fastWriteField1(buf []byte) (offset int) {
	if x.CreditCartNumber == "" {
		return offset
	}
	offset += fastpb.WriteString(buf[offset:], 1, x.GetCreditCartNumber())
	return offset
}
...
func (x *CreditCardInfo) sizeField1() (n int) {
	...
	n += fastpb.SizeString(1, x.GetCreditCartNumber())
	return n
}
