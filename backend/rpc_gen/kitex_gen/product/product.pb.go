...
type Product struct {
	...
	Picture     string   `protobuf:"bytes,4,opt,name=picture,proto3" json:"picture,omitempty"`         // 商品图片地址
	Price       float32  `protobuf:"fixed32,5,opt,name=price,proto3" json:"price,omitempty"`           // 商品价格
	Categories  []string `protobuf:"bytes,6,rep,name=categories,proto3" json:"categories,omitempty"`   // 商品分类
	Stock       uint32   `protobuf:"varint,7,opt,name=stock,proto3" json:"stock,omitempty"`            // 商品库存
	OwnerId     uint32   `protobuf:"varint,8,opt,name=ownerId,proto3" json:"ownerId,omitempty"`        // 商品所属用户ID
	OwnerName   string   `protobuf:"bytes,9,opt,name=ownerName,proto3" json:"ownerName,omitempty"`     // 商品所属用户名称
	SliderImgs  []string `protobuf:"bytes,10,rep,name=sliderImgs,proto3" json:"sliderImgs,omitempty"`  // 商品轮播图地址
}
...
func (x *Product) GetOwnerId() uint32 {
	if x != nil {
		return x.OwnerId
	}
	return 0
...
func (x *Product) GetOwnerName() string {
	if x != nil {
		return x.OwnerName
	}
	return ""
...
var file_product_proto_rawDesc = []byte{
	...
	0x05, 0x52, 0x08, 0x70, 0x61, 0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x22, 0x0a, 0x0c, 0x63,
	...
	0x8d, 0x02, 0x0a, 0x07, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x73, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x74, 0x6f, 0x63, 0x6b, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0d,
	0x52, 0x05, 0x73, 0x74, 0x6f, 0x63, 0x6b, 0x12, 0x18, 0x0a, 0x07, 0x6f, 0x77, 0x6e, 0x65, 0x72,
	0x49, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x49,
	...
	0x1e, 0x0a, 0x0a, 0x73, 0x6c, 0x69, 0x64, 0x65, 0x72, 0x49, 0x6d, 0x67, 0x73, 0x18, 0x0a, 0x20,
	0x03, 0x28, 0x09, 0x52, 0x0a, 0x73, 0x6c, 0x69, 0x64, 0x65, 0x72, 0x49, 0x6d, 0x67, 0x73, 0x22,
	...
	0x64, 0x75, 0x63, 0x74, 0x52, 0x07, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x32, 0xec, 0x01,
	...
	0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x39, 0x5a, 0x37,
