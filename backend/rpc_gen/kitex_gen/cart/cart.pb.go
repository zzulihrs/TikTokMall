...
func (x *ChangeQtyReq) GetUserId() uint32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *ChangeQtyResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChangeQtyResp) ProtoMessage() {}

func (x *ChangeQtyResp) ProtoReflect() protoreflect.Message {
	mi := &file_cart_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChangeQtyResp.ProtoReflect.Descriptor instead.
func (*ChangeQtyResp) Descriptor() ([]byte, []int) {
...
var file_cart_proto_rawDesc = []byte{
	...
	0x28, 0x0d, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x45, 0x0a, 0x04, 0x43, 0x61,
	...
	0x73, 0x22, 0x2d, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x43, 0x61, 0x72, 0x74, 0x52, 0x65, 0x73, 0x70,
	...
	0x0d, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x0f, 0x0a, 0x0d, 0x45, 0x6d, 0x70,
	0x74, 0x79, 0x43, 0x61, 0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x22, 0x4b, 0x0a, 0x0c, 0x43, 0x68,
	0x61, 0x6e, 0x67, 0x65, 0x51, 0x74, 0x79, 0x52, 0x65, 0x71, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73,
	...
	0x6d, 0x52, 0x04, 0x69, 0x74, 0x65, 0x6d, 0x22, 0x0f, 0x0a, 0x0d, 0x43, 0x68, 0x61, 0x6e, 0x67,
	0x65, 0x51, 0x74, 0x79, 0x52, 0x65, 0x73, 0x70, 0x32, 0xe1, 0x01, 0x0a, 0x0b, 0x43, 0x61, 0x72,
	...
	0x73, 0x70, 0x22, 0x00, 0x12, 0x36, 0x0a, 0x09, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x51, 0x74,
	0x79, 0x12, 0x12, 0x2e, 0x63, 0x61, 0x72, 0x74, 0x2e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x51,
	0x74, 0x79, 0x52, 0x65, 0x71, 0x1a, 0x13, 0x2e, 0x63, 0x61, 0x72, 0x74, 0x2e, 0x43, 0x68, 0x61,
	0x6e, 0x67, 0x65, 0x51, 0x74, 0x79, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x36, 0x5a, 0x34,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x69, 0x6b, 0x74, 0x6f,
	0x6b, 0x6d, 0x61, 0x6c, 0x6c, 0x2f, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x2f, 0x72, 0x70,
...
var file_cart_proto_goTypes = []interface{}{
	...
	(*ChangeQtyReq)(nil),  // 8: cart.ChangeQtyReq
	(*ChangeQtyResp)(nil), // 9: cart.ChangeQtyResp
}
var file_cart_proto_depIdxs = []int32{
	...
	4, // 2: cart.GetCartResp.cart:type_name -> cart.Cart
	0, // 3: cart.ChangeQtyReq.item:type_name -> cart.CartItem
	1, // 4: cart.CartService.AddItem:input_type -> cart.AddItemReq
	3, // 5: cart.CartService.GetCart:input_type -> cart.GetCartReq
	6, // 6: cart.CartService.EmptyCart:input_type -> cart.EmptyCartReq
	8, // 7: cart.CartService.ChangeQty:input_type -> cart.ChangeQtyReq
	...
	9, // 11: cart.CartService.ChangeQty:output_type -> cart.ChangeQtyResp
