    ...
    <div class="col-lg-8 col-sm-12">
        <form method="post" action="/checkout/waiting">
            ...
            <label for="email" class="form-label col-12">
                <input class="form-control" id="email" type="email" placeholder="Email" name="email" aria-label="email"
            ...
            <div class="mb-3 mt-3 col-12 row">
                <label for="city" class="col-md-6 col-sm-12">
                    <input type="text" id="city" class="form-control" placeholder="City" name="city" value="hangzhou">
                </label>
            ...
            <label for="country" class="mb-3 mt-3 form-label col-12">
                <input type="text" class="form-control" id="country" name="country" placeholder="Country" value="china">
            </label>
            <h4 class="mb-3 mt-3">
                Payment
            </h4>
